    ...
    var body: some View {
            ZStack{
                ...
                .sheet(isPresented:$showsheet) {
                    VStack(spacing:-30){
                        let a=Amount*(pow(1+rate/100,years))
                        Text("Estimated Returns: ₹\((a-Amount).rounded().formatted())")
                            .padding()
                            .bold()
                            .background(Color.white)
                            .cornerRadius(20)
                            .padding()
                        Text("Total Value: ₹\(a.rounded().formatted())")
                            .padding()
                            .bold()
                            .background(Color.white)
                            .cornerRadius(20)
                            .padding()
                        Text("Invested Value: ₹\(Amount.rounded().formatted())")
                            .padding()
                            .bold()
                            .background(Color.white)
                            .cornerRadius(20)
...
struct FixedDepo_Previews: PreviewProvider {
